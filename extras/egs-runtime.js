;(function (root) {
  "use strict";
  var _EGSRuntime = function (realRequire) {
    ...
    require['./runtime'] = function () {
      ...
      (function (GLOBAL) {
        ...
        var __create, __defer, __fromPromise, __generatorToPromise, __import,
            ...
            EGSError, escapeHTML, fs, guessFilepath, helpers, helpersProto,
            makeHelpersFactory, Package, path, setImmediate, simpleHelpersProto;
        _this = this;
  ...
  if (typeof define === "function" && define.amd) {
    define(function (require) { return _EGSRuntime(require); });
  } else if (typeof module !== "undefined" && typeof require === "function") {
    module.exports = _EGSRuntime(require);
  } else {
    root.EGSRuntime = _EGSRuntime();
  }
}(this));