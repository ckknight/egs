    ...
    function _step(_received) {
      while (true) {
        ...
        case 11:
          ...
          _state = 13;
          break;
        case 12: throw Error("Expected at least one filename by this point");
        case 13:
          ++_state;
          return {
            done: false,
        ...
        case 25:
          ...
          startTime = Date.now();
          output = argv.output || path.join(os.tmpdir(), "egs-" + __strnum(Math.random().toString(36).slice(2)) + ".js");
          if (argv.map) {
        ...
        case 26:
          _state = argv.output ? 27 : 28;
          break;
        case 27:
          _state = 31;
          return {
            done: true,
            value: process.stdout.write(" " + __strnum(((Date.now() - startTime) / 1000).toFixed(3)) + " s\n")
          };
        case 28:
          ++_state;
