(function (GLOBAL) {
  ...
  var __create, __defer, __fromPromise, __generatorToPromise, __import, __in,
      ...
      _ref, _this, compile, compileCode, compileFile, EgsError,
      findAndCompileFile, fs, getAstPipe, getGorillascript, getPreludeMacros,
      guessFilepath, helpers, helpersProto, makeHelpersFactory, Package, path,
      render, renderFile, setImmediate, simpleHelpersProto, utils,
      withEgsPrelude;
  _this = this;
