(function (GLOBAL) {
  ...
  var __create, __defer, __fromPromise, __generator, __generatorToPromise,
      ...
      __typeof, compile, compileFile, findAndCompileFile, fs, getPreludeMacros,
      gorillascript, guessFilepath, handleExtendsKey, helpers, path, render,
      renderFile, setImmediate, utils, writeKey;
      ...
      while (true) {
        ...
        case 1:
          ...
          return {
            ...
            value: gorillascript.compile(egsCode, ((_ref = __import({}, compileOptions)).embedded = true, _ref.embeddedGenerator = true, _ref.noindent = true, _ref.macros = macros, _ref))
          };
        case 2:
          result = _received;
          ++_state;
  ...
  function makeStandardHelpers(options) {
    var _ref, blocks, escaper, extendedByKey, extendedByLocalsKey, filepathKey,
        inPartialKey, write;
    filepathKey = makeUid();
    ...
    _ref["extends"] = function (name, locals) {
      ...
      this[extendedByKey] = findAndCompileFile(name, this[filepathKey], options);
        ...
        while (true) {
          ...
          case 0:
            ...
            return {
              ...
              value: findAndCompileFile(name, _this[filepathKey], options)
            };
          case 1:
            _ref = _received;
  ...
  function build(egsCode, options) {
    if (options == null) {
      options = {};
    }
    return makeTemplate(
  ...
  function buildFromFile(filepath, options) {
    if (options == null) {
      options = {};
    }
    ...
    function _step(_received) {
      while (true) {
        ...
        case 0:
          ...
          template = build(egsCode, siftOptions(options));
          ++_state;
    ...
    function _step(_received) {
      while (true) {
        ...
        case 0:
          ...
          options.filename = filepath;
          template = buildFromFile(filepath, siftOptions(options));
          ++_state;
          return { done: false, value: template(context || options.context || options) };
        case 1:
          ++_state;
  ...
  build.fromFile = buildFromFile;
  build.render = render;
  build.renderFile = renderFile;
  build.__express = function (path, options, callback) {
    var fun;
    if (options == null) {
      options = {};
    }
