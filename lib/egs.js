(function (GLOBAL) {
  ...
  var __create, __defer, __fromPromise, __generatorToPromise, __import, __in,
      __isArray, __owns, __promise, __slice, __toArray, __toPromise, __typeof,
      _ref, _this, ast, compile, compileFile, EgsError, findAndCompileFile, fs,
      getAstPipe, getPreludeMacros, gorillascript, guessFilepath, helpers,
      helpersProto, makeHelpersFactory, Package, path, render, renderFile,
      setImmediate, simpleHelpersProto, utils;
  _this = this;
  ...
  getAstPipe = (function () {
    ...
    function unwrapEscapeH(node) {
      ...
      if (isContextCall(node, "escape") && node.args.length === 1) {
        arg = node.args[0];
        if (arg && isContextCall(arg, "h") && arg.args.length === 1) {
          return arg.args[0];
        }
      }
    }
  ...
  compile = __promise(function (egsCode, compileOptions, helperNames) {
    var _e, _err, _ref, _send, _state, _step, _throw, _tmp, code, isGenerator,
        macros, options;
    _state = 0;
    function _close() {
      _state = 7;
    ...
    function _step(_received) {
      while (true) {
        ...
        case 1:
          ...
          _ref.macros = macros;
          _ref.prelude = null;
          _ref.astPipe = getAstPipe(helperNames);
          options = _ref;
          isGenerator = false;
          ++_state;
        case 2:
  ...
  simpleHelpersProto = __import(__create(GLOBAL), helpers);
  _ref = __import(__create(GLOBAL), helpers);
  ...
  Package = (function () {
    ...
    _Package_prototype.set = function (filepath, func, options) {
      if (options == null) {
        options = {};
      }
      filepath = withLeadingSlash(filepath);
      this.factories[filepath] = func;
      this.templates[filepath] = makeTemplate(
        returnSame(__defer.fulfilled({ func: func, isSimple: false })),
    ...
    _Package_prototype.setGenerator = function (filepath, generator, options) {
      var factory;
      if (options == null) {
        options = {};
      }
      ...
      function _step(_received) {
        while (true) {
          ...
          case 0:
            ...
            ++_state;
            return { done: false, value: template.maybeSync(data) };
          case 1:
            ++_state;
            return { done: true, value: _received };
          case 2:
